        ...
        <div class="page-content">
            <div class="page-head">
                ...
                <div class="page-title" style="padding-left:178px !important">
                    ...
                    <h1>Gestion des Collaborateurs <small>Modifier du Collaborateur</small></h1>
                ...
                <div class="col-md-offset-2 col-md-7" style="">
                    ...
                    <div class="portlet box blue-chambray">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Modification du Collaborateur
                            </div>
                            <div class="tools">
                                    ...
                                    <div class="col-md-12">
                                        <?php if ($profil) : ?>
                                            <?php foreach ($profil as $infos) : ?>
                                                <form class="form-horizontal" action="<?php echo site_url('Collaborateur/update')."/".$infos->id_user; ?>" method="post" role="form">
